...
The API calls referenced below are integrated in the [Android SDK](https://developer.relayr.io/documents/Android/Reference) and [iOS Framework](https://developer.relayr.io/documents/iOS/Reference), the below example is a suggestion for implementation in a JavaScript based client.
